...
class Config:
    def __init__(self) -> None:
        ...
        self.mixed_precision = ["no", "fp16", "bf16", "fp8"][
            2
        ]  # 2. FP8 doesn't show acceleration in the torch.compile mode.
        ...
        self.num_workers = max(
            4, self.batch_size
        )  # will be decreased to min(it, batch_size) at the initialization of the data_loader
        ...
        self.lateral_channels_in_collection = {
            ...
            "dino_v3_7b": [4096] * 4,
            "dino_v3_h_plus": [1280] * 4,
            "dino_v3_l": [1024] * 4,
            "dino_v3_b": [768] * 4,
            "dino_v3_s_plus": [384] * 4,
            "dino_v3_s": [384] * 4,
        ...
        model_name_to_weights_file = {
            "dino_v3_7b": "vit_7b_patch16_dinov3.lvd1689m.pth",
            "dino_v3_h_plus": "vit_huge_plus_patch16_dinov3.lvd1689m.pth",
            "dino_v3_l": "vit_large_patch16_dinov3.lvd1689m.pth",
            "dino_v3_b": "vit_base_patch16_dinov3.lvd1689m.pth",
            "dino_v3_s_plus": "vit_small_plus_patch16_dinov3.lvd1689m.pth",
            "dino_v3_s": "vit_small_patch16_dinov3.lvd1689m.pth",
            "swin_v1_l": "swin_large_patch4_window12_384_22kto1k.pth",
            "swin_v1_b": "swin_base_patch4_window12_384_22kto1k.pth",
            "swin_v1_t": "swin_tiny_patch4_window7_224_22kto1k_finetune.pth",
            "swin_v1_s": "swin_small_patch4_window7_224_22kto1k_finetune.pth",
            "pvt_v2_b5": "pvt_v2_b5.pth",
            "pvt_v2_b2": "pvt_v2_b2.pth",
            "pvt_v2_b1": "pvt_v2_b1.pth",
            "pvt_v2_b0": "pvt_v2_b0.pth",
        }
        self.weights = {}
        for model_name, weights_file in model_name_to_weights_file.items():
            if "dino_v3" in model_name:
                ...
                model_name_dir = ""
            self.weights[model_name] = os.path.join(
                self.weights_root_dir, model_name_dir, weights_file
            )
